module.exports = {
    manyVehiclesOneTurn: manyVehiclesOneTurn
}

var helpers = require( './helpers' );

function manyVehiclesOneTurn( map ){
      ...
      for (var row = 0; row < rows; row++) {
          for (var column = 0; column < columns; column++) {
              if ((map[row][column] > 0) && (map[row][column] <= 9)) {
                  cars[map[row][column]]= new Array(3);
                  cars[map[row][column]][0] = map[row][column];
                  cars[map[row][column]][1] = x;
                  cars[map[row][column]][2] = y;
              }
          }
      }
  }
