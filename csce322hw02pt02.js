module.exports = {
    oneVehicleManyTurns: oneVehicleManyTurns
}

var helpers = require( './helpers' );

function oneVehicleManyTurns( map ){
  ...
  function continue_moving(turn) {
      ...
      console.log("map[x][y] " + map[x][y] + " x " + x + " y " + y + current_turn);
      if (current_turn == 'n') {
          if (map[x - 1][y] == 'x') {
              if (moved == false) {
                  cannot_start = true;
      ...
      if (current_turn == 'e') {
          if (map[x][y + 1] == 'x') {
            ...
            console.log("hi" + moved + " " + cannot_start);
              swap(x, y + 1);
              moved = true;
          }
      }
  ...
  function move_checker(turn) {
      ...
      while (move_check == true) {
          ...
          if(moved == false){
            ...
            console.log("else if After map[x][y] " + map[x][y] + " x " + x + " y " + y + " moved " + moved + "cannot start" + cannot_start);
